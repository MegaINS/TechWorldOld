...
public class Frustum {
    ...
    public boolean cubeInFrustum(AxisAlignedBB aabb) {
        return this.cubeInFrustum((float)aabb.minX/4, (float)aabb.minY/4, (float)aabb.minZ/4, (float)aabb.maxX/4, (float)aabb.maxY/4, (float)aabb.maxZ/4);
    }
    public boolean chunkInFrustum(ChunkPosition aabb) {
        return this.cubeInFrustum(aabb.minX()/4, aabb.minY()/4, aabb.minZ()/4, aabb.maxX()/4, aabb.maxY()/4, aabb.maxZ()/4);
    }
